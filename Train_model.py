...
## Our architecture consists of 5 blocks each consisting of a convolution layer followed by a Max pooling layer
## 

model = Sequential()
model.add(Conv2D(643,(3,3),input_shape=(100,100,1),activation="relu"))
...
model.save("CNN_model_MRL.h5")
loss,accuracy, precision = model.evaluate(valid_image_gen)
